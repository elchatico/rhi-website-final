      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        <AnimatedSection className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="h-64 rounded-lg overflow-hidden shadow-lg">
             <img src="/images/mission.png" alt="Team working together" className="w-full h-full object-cover"/>
          </div>
        </AnimatedSection>

        <AnimatedSection className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 h-64 rounded-lg overflow-hidden shadow-lg">
             <img src="/images/vision.jpg" alt="Vision for the future" className="w-full h-full object-cover"/>
          </div>
